...
CREATE TABLE `pms_product` (
  ...
  `price_v2` decimal(18,4) DEFAULT NULL,
  `promotion_price` decimal(10,2) DEFAULT NULL,
  `promotion_price_v2` decimal(18,4) DEFAULT NULL,
  `gift_point` int NOT NULL DEFAULT 0,
  `sub_title` varchar(255) DEFAULT NULL,
  `original_price` decimal(10,2) DEFAULT NULL,
  `original_price_v2` decimal(18,4) DEFAULT NULL,
...
CREATE TABLE `knowledge_doc_version` (
  ...
  `publication_version` varchar(64) DEFAULT NULL,
  `retrieval_epoch` bigint NOT NULL DEFAULT 0,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `embedding_cache` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_embedding_cache_hash_model_epoch` (`content_hash`, `embedding_model`, `retrieval_epoch`),
  KEY `idx_embedding_cache_expired` (`expired_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE `knowledge_retrieval_epoch` (
  `id` tinyint NOT NULL,
...
INSERT INTO `knowledge_retrieval_epoch` (`id`,`epoch`) VALUES (1,0);
